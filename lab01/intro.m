...
% This is a very brief and quick introduction to \textsc{MATLAB}
% Read also the corresponding sections in the \textsc{MATLAB} documentation
% MATLAB documentation can be found here: https://www.mathworks.com/help/matlab

%% variables
alpha1 = 10 % scalar
vec1 = [1, 2, 3] % row vector. Commas may be ommitted
vec2 = [1; 2; 3] % column vector
xValues = 0:0.01:2*pi % range vector start value: increment: stop value
...
% 2d plotting
plot(xValues, yValues, 'k', 'LineWidth', 2) % What is 'k'? black, k is black.
...
%publish('intro.m','pdf') % PDF
%publish('intro.m','doc') % MS Word